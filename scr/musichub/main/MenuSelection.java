...
public class MenuSelection {
	...
	public static void main(String[] args) {
		...
		//initialisation d'util en parcourant les trois xml.
	...
	// Methods needed for the programm
	...
	public static void addASongToTheSongsList(Util util, Scanner sc) {
		...
		System.out.println(" Write the content. (You must choose .wav)");
	...
	public static void createAPlaylist(Util util, Scanner sc) {
		...
		int nbAudioBooks = Integer.parseInt(sc.nextLine());
		i=1;
